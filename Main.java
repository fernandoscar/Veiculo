/**
 * Classe principal para testar o sistema de locação de veículos.
 * Conforme Item 5 do PDF.
 */
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // --- 4. Calcular diárias com desconto (Item 5.4) ---
